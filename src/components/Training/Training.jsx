...
import { training } from "../../Constant";

const Training = () => {
  return (
    <section
      id="training"
      className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[16vw] font-sans  bg-no-repeat bg-cover  clip-path-custom-3"
      style={{
        backgroundImage: `
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-white">Training</h2>
        <div className="w-32 h-1 bg-purple-500 mx-auto mt-4"></div>
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          A collection of the training programs I have completed and the roles I have undertaken during hands-on learning and project-based environments.
        </p>
      </div>
        ...
        {training.map((training, index) => (
          ...
          >
            ...
            >
              ...
              <p className="mt-4 text-justify text-gray-400">{training.desc}</p>
              <div className="mt-4">
