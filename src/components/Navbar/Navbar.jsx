...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[14vw] ${isScrolled ? "bg-[#050414]/70 backdrop-blur-md  shadow-md" : "bg-transparent"} `}>
      ...
      <div className='text-white py-5 flex justify-between items-center'>
        ...
        <div className='text-lg font-bold cursor-pointer'>
          ...
          <span className='text-[#fff]'> Praveen </span>
          <span className='text-[#8245ec]'>/ </span>
        ...
        {
          isOpen && (
            <div className='absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414]/70  backdrop-filter backdrop-blur-lg z-50 rounded-lg shadow-lg md:hidden' >
